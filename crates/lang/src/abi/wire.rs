...
//! why [`fields()`](crate::abi::wire::fields) is here: the framing is the wire,
//! not the direction.
//!
...
pub fn fields(mut framed: &[u8]) -> Option<Vec<&[u8]>> {
